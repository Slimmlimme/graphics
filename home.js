function home() {
    ...
    this.homeWallVertex = [
        new Complex(101.25, 101.25),
        new Complex(101.25, 158.75),
        new Complex(158.75, 158.75),
        new Complex(158.75, 101.25)
    ];

    this.homeRoofVertex = [
        new Complex(101.25, 101.25),
        new Complex(130, 66.5),
        new Complex(158.75, 101.25)
    ];

    this.homeWinVertex = [
        new Complex(112.75, 112.75),
        new Complex(112.75, 147.25),
        new Complex(147.25, 147.25),
        new Complex(147.25, 112.75)
    ];

    this.homeChimneyVertex = [
        new Complex(144.25, 83.5),
        new Complex(158.75, 101.25),
        new Complex(155.75, 101.25),
        new Complex(155.75, 83.5)
    ];
    ...
    this.scale = function(coef) {
        ...
        for (var i = 0; i < homeChimneyV.length; i++) {
            homeChimneyV[i].x *= coef;
            homeChimneyV[i].y *= coef;
        }
